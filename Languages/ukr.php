...
define('PASSWORD_DESC', ' (Дозволяється використовувати букви, цифри, дефізи і підкреслювання від 6 до 18 символів)');
define('PASSWORD2', 'Повторіть пароль');
define('EMAIL', 'Електронна адреса');
define('EMAIL_ERROR', 'Некоректно введено електронну адресу');
define('HOMEPAGE', 'Домашня сторінка');
define('MESSAGE', 'Повідомлення');
define('DATE', 'Дата');
define('CAPTCHA', 'Капча');
define('CAPTCHA_ERROR', 'Невірно введено капчу!');
define('CHANGE_CAPTCHA', 'Оновити капчу');
define('ENTER_CAPTCHA', 'Введіть капчу');
define('URL_ERROR', 'Некоректно введено url');
define('IMG', 'Зображення');
define('IMG_ERROR', 'Формат зображення повенен бути: jpg, png');
define('IMG_UPLOAD_ERROR', 'Помилка при завантаженні зображення');
define('ADD_MESSAGE', 'Добавити повідомлення');
...
//ADMIN PANEL
define('ACTION', 'Дія');
define('MANAGE', 'Адмініструвати');
define('MANAGE_USERS', 'Адміністрування користувачів');
